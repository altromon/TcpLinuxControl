/********************************************************************************************************
* Fichero lee_IP.c											*
* Esta fichero contiene una funcion que sirve para obtener la IP de un dispositivo a través de una 	*
...
*	- char res[15]: parte dedicada a la dirección IP contenida en dir				*
* Descripcion general:											*
*	-  Funcion encargada de obtener la IP de un equipo a partir de una cadena mayor que la contiene	*
********************************************************************************************************/
void lectura_IP (char dir[30],char res[15])
{
	int i;
